...
(function () {
    ...
    const DEFAULT_EVENTS = [
        ...
        { id: 'sncf-out', date: '2026-09-24', start: '12:30', end: '', category: 'train', title: 'Train to Saumur — Paris Montparnasse → Saumur', location: 'Gare Montparnasse, Paris', notes: 'SNCF · 5 passengers · €288.75\nRefs ZIY6T3, RZTUI2, AFE9QL, FJJN8Q, MAWA61, QVS4C1 — tickets in the SNCF Connect app\nPlatform closes 2 min before departure · Saumur station is about 15 min from Château de Jalesnes' },
        ...
        { id: 'jalesnes-checkout', date: '2026-09-27', start: '10:43', end: '', category: 'train', title: 'Check out · Train to Paris — Saumur → Paris Montparnasse', location: 'Gare de Saumur', notes: 'Check out of Château de Jalesnes before the train\nTER 859013 connecting to TGV INOUI 8868 (1st class) · 5 passengers · €458.75\nE-ticket ref 8KS36U in the SNCF Connect app · Print tickets for refs YNV1B6, UU1594, K8VYXW, 3HFTMM, RL2H3P\nPlatform closes 2 min before departure · Check in at Le Prince Régent after 3:00 PM' },
